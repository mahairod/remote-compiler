...
/**
 * Тип <code>БазаОболочки</code> предназначен для 
 * 
 * @author Антон Астафьев
 * @since Ява-8
 * 
 */
abstract class БазаОболочки<База, ТелеБаза extends СопряжениеТелеМаркер> extends РасширениеБазыОболочки<База, ТелеБаза> implements ОболочкаТелеКласса<База, ТелеБаза> {
	protected final ТелеБаза база;
	protected final ДелегированиеОболочки ди;

	БазаОболочки(ТелеБаза база){
		this.база = база;
		this.ди = new ДелегированиеОболочки(this);
	}

	@Подмени @Override
	public ТелеБаза дайОснову(){
		return база;
	}
