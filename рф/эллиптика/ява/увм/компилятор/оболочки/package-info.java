 ...
 */
/**
 * Пакет {@linkplain рф.эллиптика.ява.увм.компилятор.оболочки} предназначен для
 * оборачивания классов удалённого доступа к внешним по отношению к данной Ява-машине
 * средствам компиляции, исключая отклонения удалённого доступа
 * 
