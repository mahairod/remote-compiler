...
/**
 * Тип <code>ОболочкаДиагностирующегоСлушателя</code> предназначен для 
 * 
 * @author Антон Астафьев
 * @since Ява-8
 * 
 */
class ОболочкаДиагностирующегоСлушателя<Исх> extends БазаОболочки<DiagnosticListener<Исх>, ТелеДиагностирующийСлушатель<Исх>> implements DiagnosticListener<Исх>, ТелеДиагностирующийСлушатель<Исх> {

	ОболочкаДиагностирующегоСлушателя(ТелеДиагностирующийСлушатель<Исх> ядро) {
		super(ядро);
	}
	
	@Подмени @Подмени
	public void report(Diagnostic<? extends Исх> диагностика) {
		ди.телеВызов(база::report, диагностика);
	}
