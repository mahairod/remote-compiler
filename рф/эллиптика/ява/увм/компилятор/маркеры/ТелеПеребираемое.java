 ...
 */
public interface ТелеПеребираемое<Тип> extends СопряжениеТелеМаркер {
	ТелеПереборщик<Тип> итератор() throws RemoteException;

	public interface ТелеПереборщик<Тип> extends СопряжениеТелеМаркер {
		boolean естьСледующий() throws RemoteException;
		Тип следующий() throws RemoteException;
		void удали() throws RemoteException;
	}
}
