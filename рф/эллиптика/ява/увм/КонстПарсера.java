...
/**
 * Тип <code>КонстПарсера</code> предназначен для 
 * 
 * @author Антон Астафьев
 * @since Ява-8
 * 
 */
public interface КонстПарсера {
	Строка Строка_Непровер_Oткл = "unchecked";
	Строка Строка_Опер_не_поддерж = "Операция не поддерживается";
}
